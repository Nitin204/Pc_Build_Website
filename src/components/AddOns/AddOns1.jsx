                    ...
                    <div className="w-full lg:w-64 bg-gray-950 p-4 lg:p-6 rounded-lg border border-red-500 h-fit">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 lg:grid-cols-1 gap-2">
                                ...
                                <button onClick={() => setPriceRange([8000, 50000])} className="w-full text-left px-3 py-2 bg-gray-800 hover:bg-gray-700 rounded text-xs lg:text-sm">Above ₹8,000</button>
                                <button onClick={() => setPriceRange([0, 50000])} className="w-full text-left px-3 py-2 bg-red-600 hover:bg-red-700 rounded text-xs lg:text-sm col-span-2 lg:col-span-1">All Prices</button>
                            </div>
                        </div>
                    </div>
